...
<footer className="bg-white dark:bg-gray-800 w-full py-8">
    <div className="max-w-screen-xl mx-auto px-4">
        <div className="pt-8 flex max-w-xs mx-auto items-center justify-center">
            ...
            <a href="https://github.com/rodrigoaveloes" className="text-gray-400 hover:text-gray-800 dark:hover:text-white transition-colors duration-200 mx-3">
            ...
            <a href="https://www.linkedin.com/in/rodrigo-avel%C3%B5es-a4a560208" className="text-gray-400 hover:text-gray-800 dark:hover:text-white transition-colors duration-200 mx-3">
